...
public class AppTest extends BaseTest {
  ...
  public Object[][] getData() {
    ...
    /*
     * data[1][0] = 98752; data[1][1] = "Second product"; data[1][2] = 50000; data[1][3] = 2;
     * 
     * data[2][0] = 45679; data[2][1] = "Third product"; data[2][2] = 16000; data[2][3] = 5;
     * 
     * data[3][0] = 1329787; data[3][1] = "Fourth product"; data[3][2] = 29990; data[3][3] = 4;
     */
